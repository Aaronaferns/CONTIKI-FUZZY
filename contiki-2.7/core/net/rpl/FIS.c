...
int main(){
    uint16_t q;
    uint16_t qual;
    unsigned short etx[] = {0, 2, 10, 15, 3, 15, 4};
    unsigned short delay[] = {0, 1000, 700, 500, 700, 2500, 122};
    unsigned short hc[] = {0, 2, 1, 2, 1, 3, 75};
    unsigned short energy[] = {255, 200, 225, 200, 250, 75, 254};
    for(int i = 0; i<7; i++){
