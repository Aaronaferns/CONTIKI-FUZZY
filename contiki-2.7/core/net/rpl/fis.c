...
//     uint16_t q;
//     uint16_t qual;
//     unsigned short etx[] = {5, 2, 10, 15, 3, 15};
//     unsigned short delay[] = {1500, 1000, 700, 500, 700, 2500};
//     unsigned short hc[] = {3, 2, 1, 2, 1, 3};
//     unsigned short energy[] = {200, 200, 225, 200, 250, 75};
//     for(int i = 0; i<6; i++){
